...
public class CountPairedCharacterInString {           
	...
	public static void main(String[] args) {
		...
		System.out.println(count);     // repeated counts are summed and display in console = 10 //
	    ...
	    for(Character s : ch) {
	    	System.out.println(s +"="+ map.get(s));  // output a=2, b=4, cdeghik(shouldn't display in console window), f=1, j=3 //
	    }
